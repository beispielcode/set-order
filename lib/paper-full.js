  ...
  var Color = Base.extend(
    new (function () {
      var types = {
        ...
        p3: ["red", "green", "blue"], // Add P3 support
      ...
      function fromCSS(string) {
        ...
        if (match) {
          ...
          (match = string.match(
            /^color\(\s*display-p3\s+([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?)\s+([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?)\s+([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?)\s*(?:\/\s*([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?))?\s*\)$/
          ))
        ) {
          // Handle P3 color format with improved regex
          type = "p3";
          components = [
            parseFloat(match[1]),
            parseFloat(match[2]),
          ...
          if (match[4] !== undefined) {
            components.push(parseFloat(match[4])); // Alpha
          }
      ...
      var converters = {
        ...
        // Add P3 converters
        "p3-rgb": function (r, g, b) {
          // P3 to XYZ D65 matrix
          var p3ToXYZ = [
          ...
          // Convert P3 to XYZ
          var x = p3ToXYZ[0][0] * r + p3ToXYZ[0][1] * g + p3ToXYZ[0][2] * b;
          var y = p3ToXYZ[1][0] * r + p3ToXYZ[1][1] * g + p3ToXYZ[1][2] * b;
          var z = p3ToXYZ[2][0] * r + p3ToXYZ[2][1] * g + p3ToXYZ[2][2] * b;
        ...
        "rgb-p3": function (r, g, b) {
          ...
          // Convert XYZ to P3
          var p3R = xyzToP3[0][0] * x + xyzToP3[0][1] * y + xyzToP3[0][2] * z;
          var p3G = xyzToP3[1][0] * x + xyzToP3[1][1] * y + xyzToP3[1][2] * z;
          var p3B = xyzToP3[2][0] * x + xyzToP3[2][1] * y + xyzToP3[2][2] * z;
        ...
        // Add P3 to other color space converters
        "p3-hsb": function (r, g, b) {
          return converters["rgb-hsb"].apply(
            this,
            converters["p3-rgb"](r, g, b)
          );
        },

        "hsb-p3": function (h, s, b) {
          return converters["rgb-p3"].apply(
            this,
            converters["hsb-rgb"](h, s, b)
          );
        },

        "p3-hsl": function (r, g, b) {
          return converters["rgb-hsl"].apply(
            this,
            converters["p3-rgb"](r, g, b)
          );
        },

        "hsl-p3": function (h, s, l) {
          return converters["rgb-p3"].apply(
            this,
            converters["hsl-rgb"](h, s, l)
          );
        },

        "p3-gray": function (r, g, b) {
          return converters["rgb-gray"].apply(
            this,
            converters["p3-rgb"](r, g, b)
          );
        },
        ...
        "gray-p3": function (g) {
          return converters["rgb-p3"].apply(this, converters["gray-rgb"](g));
        },
      ...
      return Base.each(
        ...
        },
        {
          ...
          toCSS: function (hex) {
            // If this is a P3 color, output P3 CSS
            if (this._type === "p3") {
          ...
          toCanvasStyle: function (ctx, matrix) {
            ...
            if (this._type !== "gradient") {
              // For P3 colors, use the P3 CSS format directly
              if (this._type === "p3") {
          ...
          statics: {
            ...
            // Add P3 helper methods
            fromP3: function (r, g, b, a) {
              return new Color("p3", [r, g, b], a);
            },

            fromP3String: function (p3String) {
              return new Color(p3String);
            },
  ...
  var CanvasProvider = (Base.exports.CanvasProvider = {
    ...
    release: function (obj) {
      ...
      if (canvas && canvas.getContext) {
        canvas.getContext("2d", { colorSpace: "display-p3" }).restore();
